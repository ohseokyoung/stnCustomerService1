    ...
    <main>
        ...
        <article>
            <h2 style="margin-top:100px; margin-bottom:70px;">고객센터 문의 글쓰기</h2> 
                <div class="board">
                    <form action="/campus/customer/customerWriteOk" method="post" id="writeFrm">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="title" name="subject" placeholder="제목을 입력하세요" required>
                        </div>
                        ...
                        <input type="hidden" id="logId" value="<%=session.getAttribute("logId")%>">
                    </form>
                </div>          
        </article>
    </main>
